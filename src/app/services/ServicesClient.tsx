    ...
    return (
        <div className="flex flex-col bg-[var(--app-bg)] text-[var(--app-text)]">
                        ...
                        <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-stretch min-h-[540px]`}>
                            ...
                            >
                                ...
                                <span
                                    ...
                                    style={{ color: 'rgba(255,218,104,0.06)' }}
                                    aria-hidden
                                >
            ...
            {data.packages.length > 0 && (
                <section className="relative py-24 md:py-32 bg-[#090805] border-b border-white/5 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-20">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                            {data.packages.map((pkg, index) => {
                                const featured = index === data.packages.length - 1;
