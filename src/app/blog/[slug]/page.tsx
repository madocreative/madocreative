    ...
    return (
        <div className="bg-[#0a0a08] min-h-screen pt-32 pb-24 text-white">
            <div className="max-w-4xl mx-auto px-6 lg:px-12">
                <Link href="/blog" className="inline-flex items-center gap-2 text-slate-400 hover:text-[#f2b90d] transition-colors mb-10 text-sm font-bold uppercase tracking-wider">
                    <span className="material-symbols-outlined text-sm">arrow_back</span> Back to Journal
                </Link>

                <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-[#f2b90d] mb-6">
                ...
                <div
                    className="prose prose-invert prose-lg max-w-none prose-p:text-slate-300 prose-headings:font-display prose-headings:text-white prose-a:text-[#f2b90d] prose-a:no-underline hover:prose-a:underline"
