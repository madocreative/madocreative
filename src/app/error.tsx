...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-[#05070A] text-[#EAEAEA] flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-2xl rounded-[1.75rem] border border-white/10 bg-[#0A0F18] p-8 md:p-12 shadow-[0_30px_80px_rgba(0,0,0,0.35)]">
        ...
        <h1 className="text-4xl md:text-5xl font-display font-bold leading-[0.95] text-white">
          We&apos;re reconnecting the studio.
        </h1>
        <p className="mt-5 max-w-xl text-sm md:text-base leading-8 text-white/72">
          A server-side data source is temporarily unavailable. Please retry in a moment, or continue browsing the rest of the site.
        </p>
