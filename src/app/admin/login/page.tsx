        ...
        <div className="min-h-screen flex items-center justify-center bg-[#0a0a08] px-6">
            <div className="bg-[#1a1812] p-10 rounded-xl border border-white/10 shadow-2xl w-full max-w-md">
                <div className="flex flex-col items-center mb-8">
                    <div className="w-16 h-16 bg-[#f2b90d] rounded-full flex items-center justify-center mb-4">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            ...
                            className="bg-[#221e10] border border-white/10 rounded-lg px-4 py-4 text-white focus:outline-none focus:border-[#f2b90d] transition-colors font-mono"
                            placeholder="••••••••"
                            required
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="bg-[#f2b90d] text-[#0a0a08] py-4 rounded-lg font-bold text-lg uppercase tracking-wider hover:brightness-110 active:scale-[0.98] transition-all flex justify-center mt-2 disabled:opacity-50"
                    >
