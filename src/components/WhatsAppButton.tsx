...
export default function WhatsAppButton({ number }: { number: string }) {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-5 z-50 flex items-center justify-end gap-3"
    >
      ...
      <span
        className="
          ...
          bg-white text-[#111] text-xs font-semibold tracking-wide
      ...
      <span
        className="
          ...
          group-hover:shadow-[0_6px_32px_rgba(37,211,102,0.65)]
